...
@Config
public class BlueRightAlly extends LinearOpMode {
...
//        arm.setPosition(armPos);
        ...
        TrajectorySequence path1 = drive.trajectorySequenceBuilder(start)
                ...
                .lineToConstantHeading(new Vector2d(-33.00, 42.00))
                .lineToLinearHeading(new Pose2d(-36.00, 9.00, Math.toRadians(0.00)))
                .splineTo(new Vector2d(13.00, 9.00), Math.toRadians(0.00))
                .splineTo(new Vector2d(34.00, 9.00), Math.toRadians(0.00))
        ...
        TrajectorySequence path2 =  drive.trajectorySequenceBuilder(start)
                ...
                .lineToConstantHeading(new Vector2d(-55.00, 30.50))
                .lineToConstantHeading(new Vector2d(-55.00, 9.00))
                .lineToLinearHeading(new Pose2d(-24.00, 9.00, Math.toRadians(0.00)))
                .splineTo(new Vector2d(34.00, 9.00), Math.toRadians(0.00))
                .lineToLinearHeading(new Pose2d(41.50, 36.00, Math.toRadians(180.00)))
                .build();
        TrajectorySequence path3 = drive.trajectorySequenceBuilder(start)
                .splineTo(new Vector2d(-30.00, 38.00), Math.toRadians(45))
                .lineToConstantHeading(new Vector2d(-47.00, 0.00))
                .lineToLinearHeading(new Pose2d(-36.00, 9.00, Math.toRadians(0.00)))
                .splineTo(new Vector2d(13.00, 9.00), Math.toRadians(0.00))
                .splineTo(new Vector2d(34.00, 9.00), Math.toRadians(0.00))
                .lineToLinearHeading(new Pose2d(41.50, 36.00, Math.toRadians(180.00)))
