package org.firstinspires.ftc.teamcode.drive.opmode.lobstercupauton;
...
@Config
@Autonomous(group="lobster")
public class LobsterRedRight extends LinearOpMode {
...
//                .setLiveViewContainerId(cameraMonitorViewId)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence pathLeftSpike = drive.trajectorySequenceBuilder(start)
                .splineTo(new Vector2d(8.00, -32.00), Math.toRadians(180))
                .waitSeconds(0.8)
                .lineToLinearHeading(new Pose2d(39, -34.00, Math.toRadians(180.00)))
                .build();
