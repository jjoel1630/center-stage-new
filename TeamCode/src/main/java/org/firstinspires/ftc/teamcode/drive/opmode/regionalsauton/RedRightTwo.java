...
public class RedRightTwo extends LinearOpMode {
...
//                            .lineToLinearHeading(new Pose2d(28.00, -10.00, Math.toRadians(180.00)))
                            .lineToConstantHeading(new Vector2d(28.00, -10.00))
//                            .lineToLinearHeading(new Pose2d(-28.00, -10.00, Math.toRadians(180.00)))
                            .lineToConstantHeading(new Vector2d(-60, -10.00))
...
//                            .lineToLinearHeading(new Pose2d(-26.00, -10, Math.toRadians(180.00)))
                ...
                case WHITE_STUFF_SCORE:
                    arm.raise();
                    claw.closeBoth();
                    slides.moveToPosition(slidePositionScore + 200, linearError);
                    slides.powerSlideRaw(f);
                    arm.drop();
                    waitSeconds(0.8);
                    claw.openBoth();
