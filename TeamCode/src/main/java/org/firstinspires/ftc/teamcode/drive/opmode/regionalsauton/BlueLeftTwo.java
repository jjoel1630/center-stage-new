...
public class BlueLeftTwo extends LinearOpMode {
...
//                .setLiveViewContainerId(cameraMonitorViewId)
    ...
    public static double p = 3, i = 0, d = 0, f = 0.06;
    ...
    public static double aprilTagGap = 5;
        ...
        while (opModeIsActive()) {
            ...
            switch (driverState) {
                ...
                case LIFT_SCORE:
                    ...
                    driverState = DriverState.WHITE_STUFF;

                    break;
                case WHITE_STUFF:
                    TrajectorySequence whiteScore = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                            .lineToLinearHeading(new Pose2d(28.00, 14.00, Math.toRadians(180.00)))
                            .lineToLinearHeading(new Pose2d(-28.00, 14.00, Math.toRadians(180.00)))
                            .addSpatialMarker(new Vector2d(-55, 10), () -> {
                                arm.ground();
                            })
                            .lineToLinearHeading(new Pose2d(-60.00, 11.50, Math.toRadians(180.00)))
                            .addDisplacementMarker(() -> {
                                claw.closeBoth();
                            })
                            .waitSeconds(0.8)
                            ...
                            .lineToLinearHeading(new Pose2d(-26.00, 14.00, Math.toRadians(180.00)))
                            .lineToLinearHeading(new Pose2d(33.00, 14.00, Math.toRadians(180.00)))
                            .lineToLinearHeading(new Pose2d(52.00, 36.00, Math.toRadians(180.00)))
                            .build();

                    driverState = DriverState.WHITE_STUFF_SCORE;

                    break;
                case WHITE_STUFF_SCORE:
                    arm.raise();
                    claw.closeBoth();
                    slides.moveToPosition(slidePositionScore, linearError);
                    slides.powerSlideRaw(f);
