...
public class MarkerTests extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence markerTest = drive.trajectorySequenceBuilder(new Pose2d(0, 0, 0))
        ...
        while (opModeIsActive()) {
            ...
            switch (driverState) {
                case AUTOMATIC:
                    ...
                    drive.followTrajectorySequence(markerTest);
